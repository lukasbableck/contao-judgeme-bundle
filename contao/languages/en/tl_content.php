...
$GLOBALS['TL_LANG']['tl_content']['judgemeId'] = ['Judge.me product ID', 'Enter the product ID.'];
$GLOBALS['TL_LANG']['tl_content']['judgemeLimit'] = ['Number of reviews', 'Enter the number of reviews that should be displayed at most.'];
$GLOBALS['TL_LANG']['tl_content']['productPage'] = ['Product page', 'Enter the URL of the product page.'];
